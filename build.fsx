...
let summary = "FSharp implementation of Eugene W. Myers's O(ND) difference algorithm"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "FSharp implementation of Eugene W. Myers's O(ND) difference algorithm"

// List of author names (for NuGet package)
let authors = [ "Nikola Milekic" ]

// Tags for your project (for NuGet package)
let tags = "difference algorithm myers fsharp"

// File system information
let solutionFile  = "FsMyers.sln"
...
let gitRaw = environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/nikolamilekic"
