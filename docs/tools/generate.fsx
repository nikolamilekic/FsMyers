...
let githubLink = "https://github.com/nikolamilekic/FsMyers"

// Specify more information about your project
let info =
  [ "project-name", "FsMyers"
    "project-author", "Nikola Milekic"
    "project-summary", "FSharp implementation of Eugene W. Myers's O(ND) difference algorithm"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FsMyers" ]
